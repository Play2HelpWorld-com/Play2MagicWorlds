...
const BlogData: Charity[] = [
  {
    ...
    title: "Play2MusicWorld World Water Aid",
    metadata:
      "Play2MusicWorld, an innovative platform where gaming meets social impact. Designed to bring entertainment and purpose together, Play2MusicWorld allows users to play exciting games, earn coins, and contribute to meaningful social causes.",
  },
  {
    ...
    title: "Play2MusicWorld World WWF",
    metadata:
      "Play2MusicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Play2MusicWorld World MSF Doctors Without Borders",
    metadata: "Play2MusicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Play2MusicWorld Cancer Research",
    metadata: "Play2MusicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
  ...
  },
  {
    ...
    title: "Play2MusicWorld Alzheimer's Society",
    metadata: "Play2MusicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
  {
    ...
    title: "Play2MusicWorld Red Cross",
    metadata: "Play2MusicWorld offers a wide variety of games that cater to all interests and skill levels. Players can immerse themselves in thrilling adventures, puzzles, strategy games, and more. As you play and achieve milestones, you earn coins that can be used",
  },
];
