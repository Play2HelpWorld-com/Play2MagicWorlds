...
const Integration = () => {
  ...
  const platformIcons = [
    { src: "/images/platforms/pc.svg", name: "PC Gaming", color: "#50E3C2" },
    { src: "/images/platforms/console.svg", name: "Console", color: "#FF5757" },
    { src: "/images/platforms/mobile.svg", name: "Mobile", color: "#FFD600" },
    { src: "/images/platforms/vr.svg", name: "VR", color: "#AB6AFF" },
    {
      src: "/images/platforms/cloud.svg",
      name: "Cloud Gaming",
      color: "#3F95FF",
    },
    { src: "/images/platforms/browser.svg", name: "Browser", color: "#FF9552" },
  ];
  ...
  return (
    <section className="relative overflow-hidden py-24 lg:py-32">
      {/* Animated Background */}
      <motion.div
        className="absolute inset-0 z-0 bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 bg-[length:400%_400%]"
